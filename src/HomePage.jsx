    ...
    <header className="mb-10 fixed-header bg-white mt-0">
      <nav className="flex justify-around align-middle mt-5 mb-3">
        <div className="logo flex items-center justify-center">
          <img src={logo} className="w-96 h-24 "></img>
        </div>
        <div className="get-started flex justify-center items-center">
          <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-3 px-6 rounded-xl shadow-2xl text-xl transform hover:scale-105 transition-transform duration-200">
            Get Started
          </button>
        </div>
      </nav>
    ...
    <div className="flex justify-around items-center mx-[25%] mt-[150px]">
      ...
      <div className="w-1/2 text-right flex flex-col justify-between pb-10">
        ...
        <div className="get-started flex justify-center items-center mt-4">
          <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-3 px-6 rounded-xl shadow-2xl text-3xl transform hover:scale-105 transition-transform duration-200">
            Get Started
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex justify-around items-center mt-10 mx-[25%] mb-10">
      ...
      <div className="w-1/2 text-right flex flex-col justify-between pb-10 animate-text">
        <h2 className="text-5xl font-bold mb-2 text-center text-green-500">
          {heading}
        </h2>
...
const HomePage = () => {
  return (
    <div>
      ...
      <hr></hr>
      <div className="get-started flex justify-center items-center mt-4">
        <button className="bg-green-700 hover:bg-green-900 text-white font-bold py-3 px-6 rounded-xl shadow-2xl text-3xl transform hover:scale-105 transition-transform duration-200 mb-20">
          Get Started
        </button>
      </div>
    </div>
